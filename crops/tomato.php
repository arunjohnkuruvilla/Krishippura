...
<body>
  ...
  <div class="section values" style="background-image: url('./images/tomato.jpg');">
  </div>
  <div style="padding-top:5rem">
    <div class="container">
      <div class="row">
        <a class="button button-primary" href="#">Soil Preparation</a>
        <a class="button" href="#">Planting Method</a>
        <a class="button" href="#">Watering Cycle</a>
    ...
    <?php if(!isset($_GET['stage'])) {
        ...
        echo "$_GET[stage]<br>http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]
